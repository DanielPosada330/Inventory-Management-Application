...
public abstract class Part implements Serializable {
    ...
    @Min(value = 0, message = "Inventory value can not be lower than zero")
    int minInv;
    int maxInv;
    ...
    //Add getters and setters for both min and max int values
